...
elasticdump --input=kibana-mapping.json --output=http://es-client:9200/.kibi --type=mapping
elasticdump --input=kibana-data.json --output=http://es-client:9200/.kibi --type=data
